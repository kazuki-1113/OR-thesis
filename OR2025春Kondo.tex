...
\begin{figure}[t]
  ...
  \vspace{-0.3cm}
\end{figure}
これは，サーバー運用において予算が限られている場合，高性能なCPUを用意するよりも，メモリ使用量を増やす方が効果的であることを示唆する．
今後は，より高度な拡張機能を追加し適切な設定を整えた上で，ここで得られた知見の検証を行うことが課題である．
...
\begin{thebibliography}{5}
  ...
  T. Dohi, K. Trivedi and A. Avritzer, \emph{Handbook of Software Aging and Rejuvenation}, WORLD SCIENTIFIC, pp. 73--90, 2020.
